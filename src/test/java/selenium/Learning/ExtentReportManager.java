...
public class ExtentReportManager implements ITestListener {
	...
	public static ExtentSparkReporter sparkReporter;// UI of the report//look and feel
	public static ExtentReports extent; //populate common info on the report
	public static ExtentTest test; //updating the status of the test methods and creating test case entries in the reports 
	WebDriver driver;
	...
	public void OnStart(ITestContext context) {
		...
		extent.setSystemInfo("Environment", "QA");     //key:value
		extent.setSystemInfo("Computer Name", "localhost");  //key : value like a Hash map
		extent.setSystemInfo("Test Name", "Uma");
